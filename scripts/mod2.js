...
(function () {
    ...
    const activitiesInfo = [
        ...
        {
            name: "踩住头", prerequisite: ["canStepOnHead"],
            targetSelf: "", targetSelftext: "", maxProgressSelf: 50,
            target: "ItemHead", targettext: "SourceCharacter踩住TargetCharacter的头.", maxProgress: 50,
            activityExpression: [],
    ...
    const CustomPrerequisiteFuncs = new Map(Object.entries({
        ...
        "canStepOnHead": (acting, acted, group) => acting.CanWalk() && acting.IsStanding() && (acted.IsKneeling() || ["Hogtied", "AllFours"].includes(acted.PoseMapping.BodyLower)),
    }));
